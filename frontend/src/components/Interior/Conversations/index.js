...
let conversationsArray = [
  {
    title: "Spam Warrior",
    questions: [
      "Who brings the best Ham?",
      "Which Ham is yours?",
      "Worng! All the Ham is mine!"
    ],
    // "schedule": {"tue": true, "time": "11:35", "modifier": "AM"},
    members: ["U9TKS1XJN", "U7YKKMPRS"]
  }
];
          ...
          <div className="ui card">
            <div className="content">
              ...
              <div className="card__header">
                {(dataArray[[i[0]]] = conversationsArray[i].title)}
              </div>
