...
class LandingPageIndex extends React.Component {
  ...
  handleBuyButton() {
    window.open("https://slack.com/oauth/authorize?scope=users:read,users:read.email,team:read&client_id=270618182930.333388702161&redirect_uri=https://heyteam-backend.herokuapp.com/auth/login","_self")
  }
